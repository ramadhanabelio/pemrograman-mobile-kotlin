...
import com.onlineservice.databinding.ActivityMainBinding
import com.onlineservice.databinding.NavHeaderBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_user_services, R.id.nav_user_profile, R.id.nav_logout
            ), drawerLayout
        )
